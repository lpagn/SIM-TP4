...
public class App3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        double step = 0.00001;
        LeapFrogPlanetsX lex = new LeapFrogPlanetsX(step,earth,planetsForEarth);
        LeapFrogPlanetsY ley = new LeapFrogPlanetsY(step,earth,planetsForEarth);
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            MultipleValueReturn<Double,Double> nextEx = lex.stepLeapFrog();
            MultipleValueReturn<Double,Double> nextEy = ley.stepLeapFrog();
